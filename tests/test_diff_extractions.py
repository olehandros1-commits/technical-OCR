...
async def test_identical_extractions_yield_zero_diffs():
    a = _stmt([{"date": "2025-04-01", "description": "X", "deposit": 100, "withdrawal": None}])
    b = _stmt([{"date": "2025-04-01", "description": "X", "deposit": 100, "withdrawal": None}])
...
async def test_added_and_removed_rows():
    a = _stmt([{"date": "2025-04-01", "description": "X", "deposit": 100, "withdrawal": None}])
    b = _stmt([{"date": "2025-04-02", "description": "Y", "deposit": 200, "withdrawal": None}])
    handler = DiffExtractionsHandler()
    d = await handler(DiffExtractionsQuery(result_a=a, result_b=b))
...
async def test_soft_field_changes_detected():
    base = {"date": "2025-04-01", "description": "X", "deposit": 100, "withdrawal": None}
